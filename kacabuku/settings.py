"""
Django settings for kacabuku project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-h(pe$g&z(g5)6zxboo%)%b8u=k9&_gc!dpr!$*vrgcl_+nmpeg')
...
WSGI_APPLICATION = 'kacabuku.wsgi.application'
